...
<div class="row">
    ...
    <div class="col-lg-4 col-12">
        <div class="card">
            <div class="card-body text-center pb-1">
                ...
                <span class="badge badge-light-primary mb-50">
                    <i class="feather icon-user"></i> Customer
                </span>
                <p class="mb-0">
                    <span class="badge badge-light-warning">
                        <i class="feather icon-star mr-25"></i> {{ $user->point ?? 0 }} Point
                    </span>
                </p>
            </div>
            <hr class="my-1">
    ...
    <div class="col-lg-8 col-12">
        <form action="{{ url('me', $user->id) }}" method="POST" enctype="multipart/form-data">
            @csrf @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="no_telp" value="{{ old('no_telp', $user->no_telp) }}" class="form-control" placeholder="08123...">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-12">
                            <div class="form-group mb-0">
                                ...
                                <textarea name="alamat" rows="2" class="form-control" placeholder="Alamat pengantaran">{{ old('alamat', $user->alamat) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
