...
@section('header','Tambah Data Kurir')
@section('content')
<div class="col-lg-12">
    <div class="card card-outline-info">
        ...
        <div class="card-body">
            <form action="{{route('karyawan-kurir.store')}}" method="POST">
                @csrf
                <div class="form-body">
                    <div class="row p-t-20">
                        <div class="col-md-4">
                            <div class="form-group has-success">
                                ...
                                <input type="text" class="form-control form-control-danger @error('name') is-invalid @enderror" name="name" value="{{old('name')}}" placeholder="Nama Kurir" autocomplete="off">
                                @error('name')
                        ...
                        <div class="col-md-12">
                            <div class="form-group has-success">
                                ...
                                <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror" rows="3" placeholder="Alamat Kurir"> {{old('alamat')}} </textarea>
                                @error('alamat')
                                  <span class="invalid-feedback text-danger" role="alert">
                                      <strong>{{ $message }}</strong>
                                  </span>
                ...
                <div class="form-actions">
                    ...
                    <a href=" {{route('karyawan-kurir.index')}}"  class="btn btn-outline-warning mr-1 mb-1">Batal</a>
                </div>
            </form>
        </div>
    </div>
